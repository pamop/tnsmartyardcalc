/**
  ...
  *
  * @checksum - bd89249ea23ccd5987d1ba91862b26ed42f94390ab1252d5ecebc6411ad2046f
  * @variables - radius=rounded,accentColor=teal,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
